...
FOR %%x IN ("C:\Inetpub\vhosts\servergorich.com\richiesoft.org\careers/PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Inetpub\vhosts\servergorich.com\richiesoft.org\careers/PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Inetpub\vhosts\servergorich.com\richiesoft.org\careers"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Inetpub\vhosts\servergorich.com\richiesoft.org\careers\"
